=:=====~=~~::~===::::::~?+:.:::.:~:....::::::.77777777777777777\n777777777777777777=.=====~~~~~~=~~=+===+++=+=:~:.....::::::::.777777777777777777\n7777777777777777777 .~~~==~~~=====:~===?+++~=~::.:::~::::::.:7777777777777777777\n77777777777777777777 .~~~~~~~~~===~~:...........::::::::::. 77777777777777777777\n77777777777777777777777.~~:~~=~~~~=~:~:~~~~~~~:~~~~:~~:::=7777777777777777777777\n777777777777777777777777.::~~=~=~==+???I???~+==+=~~~~~:.. 7777777777777777777777\n777777777777777777777777.~=.::~=~======+=~===~~~~~=~::.=:. 777777777777777777777\n777777777777777777777777.==+=.:~~~~~~=~~~~~~~~~~~~~~..===.7777777777777777777777\n777777777777777777777+..:+++=+==..................========..77777777777777777777\n77777777777777777...:.:==~=+++++====~===~~~==~~~~=~~=~=====...777777777777777777\n7777777777=...:+   ~..===~==+++=======~~~==~~~~~==~========...~..777777777777777\n77~..:+           :..=======~++++======~~==~=~~~~==~========...    +?...77777777\n.I                ~..============++=======~~=~~=~=~==~======:..=              ..\n.                 :.:===========~=~~==============~=========...               ..\n.                 :..=========~==~=====~===================+...               ..\n.                  :..+==========~===~=~~====+=====+===++=+~..+               ..\n.                   ..:=+=====++===============~~~~~~~=++++...                ..\n.                    ..+=+++=+=+===========+==============...                 ..\n.                     ..=+=+=+=++=====+++++===+=========...                   ..\n.                      ..++?++++=======+++++++++=++===....                    ..\n..........................=+++++++=++==+++++++++++++............................\n'
var Ready = false;
var ptr = null;
var Root = null;
...
function LoadFile(str) {
    ...
    ptr = root.children[0];
    Root = root;
    document.write('<script src="www/tilda.js"></script>');
}
...
$.interpret = function(command, terminal){
    trmi = terminal;
    if(!Ready)
        terminal.echo("Not Ready!!");
    else
    {
        if(command == '..')
        {
            ptr = ptr.pNode || Root;
            Prompt = (ptr.name + " $ ").replace('#', '');
            terminal.set_prompt(Prompt);
        }
        else if(command == '.')
        {
            ptr = ptr || Root;
            Prompt = (ptr.name + " $ ").replace(/#/g, '');
            terminal.set_prompt(Prompt);
        }
        else if(command == 'ascii')
        {
            terminal.echo(asciiArt);
        }
        else
        {
            terminal.echo("I am at node : " + ptr.name);
            arr = printChildrenNames(ptr);
            for(var i=0; i<arr.length; i++)
                terminal.echo(arr[i]);
        }
    }
